...
const licenseKey = generateLicenseKey();
  ...
  const findUser = await User.findOne({ $or: [{ email },{ phone },{pancard},{gstno}] });
  ...
  res.status(200).json({ message: "A new user created successfully, and the license key has been sent." });
});
